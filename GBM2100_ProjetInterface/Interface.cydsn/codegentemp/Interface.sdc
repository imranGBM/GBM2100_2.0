...
# Date: Sat, 03 Apr 2021 14:49:07 GMT
#set_units -time ns
...
create_generated_clock -name {I2C_1_SCBCLK} -source [get_pins {ClockBlock/periclk}] -edges {1 65 131} [list [get_pins {ClockBlock/ff_div_1}]]
create_generated_clock -name {UART_1_SCBCLK} -source [get_pins {ClockBlock/periclk}] -edges {1 73 145} [list [get_pins {ClockBlock/ff_div_2}]]
...
create_generated_clock -name {Clock} -source [get_pins {ClockBlock/periclk}] -edges {1 5001 10001} [list [get_pins {ClockBlock/ff_div_12}]]
...
# Project: C:\Users\markm\Desktop\GBM2100 - Projet Instrum\Projet\SourceTree_Files\GBM2100_ProjetInterface\Interface.cydsn\Interface.cyprj
# Date: Sat, 03 Apr 2021 14:48:42 GMT
