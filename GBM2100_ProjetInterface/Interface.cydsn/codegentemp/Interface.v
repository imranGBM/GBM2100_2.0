...
module CapSense_v3_0_3 ;
	...
	cy_mxs40_gpio_v1_0
		#(.id("30ccc117-3bfa-4518-afb2-cb56f1e7a67a/4db2e9d3-9f70-4f4e-a919-7eefada41863"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("30ccc117-3bfa-4518-afb2-cb56f1e7a67a/77fd7f86-2082-41fa-a471-914d5f07502d"),
		  .width(2),
		  .sio_grp_cnt(0),
		  .drive_mode("0,0"),
		  .ibuf_enabled("0,0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("30ccc117-3bfa-4518-afb2-cb56f1e7a67a/dbc12ae1-a607-4701-99cc-6261716a9147"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("30ccc117-3bfa-4518-afb2-cb56f1e7a67a/2605f567-73b7-435d-b3b9-174766b96934"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_clock_v1_0
		#(.id("30ccc117-3bfa-4518-afb2-cb56f1e7a67a/8273f0d6-caef-4cc7-ad3c-09656b78e2cb"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("30ccc117-3bfa-4518-afb2-cb56f1e7a67a/0113321b-4a37-46f6-8407-2f8646c68756"),
		  .width(5),
		  .sio_grp_cnt(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("30ccc117-3bfa-4518-afb2-cb56f1e7a67a/8ed50244-d239-4c9b-9207-b8e71ce193dc"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
...
module SCB_UART_PDL_v2_0_5 (
	...
	cy_clock_v1_0
		#(.id("bdbb81e9-3277-493d-963f-3670b40ba7f2/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("bdbb81e9-3277-493d-963f-3670b40ba7f2/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("bdbb81e9-3277-493d-963f-3670b40ba7f2/b7e8018e-1ef7-49c0-b5a5-61641a03e31c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("f381da11-30d3-41c6-84a0-25bdc844e320"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(0),
		  .period("50000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpFB_0__GreenAlarm_net;
	wire [0:0] tmpIO_0__GreenAlarm_net;
	electrical [0:0] tmpSIOVREF__GreenAlarm_net;
	...
	cy_mxs40_gpio_v1_0
		...
		GreenAlarm
		 (.oe({1'b1}),
		  .y({Net_588}),
		  .fb({tmpFB_0__GreenAlarm_net[0:0]}),
		  .io({tmpIO_0__GreenAlarm_net[0:0]}),
		  .siovref(tmpSIOVREF__GreenAlarm_net));


    TCPWM_PWM_PDL_v1_0_2 PWMAlarmG (
        .clock(Net_568),
        .compare(Net_569),
        .count(1'b1),
        .interrupt(Net_571),
	...
	cy_mxs40_gpio_v1_0
		#(.id("b26cea37-776a-4cfa-bb06-a0228bb88e77"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
